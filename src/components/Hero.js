		...
		<Wrapper className='section-center'>
			<article className='content'>
				...
				<p>
					...
					ut consequat semper viverra. Tellus molestie nunc non blandit massa
					enim nec. Massa tincidunt dui ut ornare. Morbi tristique senectus et
					netus et malesuada.
				</p>
			...
			<article className='img-container'>
				<img src={hero1} alt='table' className='main-img' />
